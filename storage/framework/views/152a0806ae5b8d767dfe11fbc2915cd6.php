...
<div class="hero dark-hero">
    <div class="hero-content">
        ...
        <div class="hero-buttons">
            <a href="<?php echo e(route('about')); ?>" class="btn btn-primary">Explore More</a>
...
<section class="cta-section">
    <div class="container">
        ...
        <a href="<?php echo e(route('contact')); ?>" class="btn btn-primary">Get Started</a>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Demo\resources\views/index.blade.php ENDPATH**/ ?>